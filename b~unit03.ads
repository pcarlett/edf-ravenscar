...
package ada_main is
   ...
   u00001 : constant Version_32 := 16#81d6b2ee#;
   ...
   u00015 : constant Version_32 := 16#4f486681#;
   ...
   u00027 : constant Version_32 := 16#f844feb0#;
   ...
   u00030 : constant Version_32 := 16#d6960d2f#;
   pragma Export (C, u00030, "system__bb__timeB");
   u00031 : constant Version_32 := 16#842498d0#;
   ...
   u00060 : constant Version_32 := 16#c29a14d9#;
   pragma Export (C, u00060, "system__bb__debugS");
   u00061 : constant Version_32 := 16#86348961#;
   ...
   u00063 : constant Version_32 := 16#2e4a32af#;
   pragma Export (C, u00063, "system__bb__threadsB");
   u00064 : constant Version_32 := 16#92557752#;
   ...
   u00067 : constant Version_32 := 16#0680e9c9#;
   ...
   u00069 : constant Version_32 := 16#c68b8769#;
   pragma Export (C, u00069, "system__bb__threads__queuesB");
   u00070 : constant Version_32 := 16#9a010c51#;
   pragma Export (C, u00070, "system__bb__threads__queuesS");
   u00071 : constant Version_32 := 16#5dbb99bd#;
   pragma Export (C, u00071, "system__bb__statsS");
   u00072 : constant Version_32 := 16#b012ff50#;
   pragma Export (C, u00072, "system__img_intB");
   u00073 : constant Version_32 := 16#9d8752a5#;
   pragma Export (C, u00073, "system__img_intS");
   u00074 : constant Version_32 := 16#276453b7#;
   pragma Export (C, u00074, "system__img_lldB");
   u00075 : constant Version_32 := 16#6c7ebb0e#;
   pragma Export (C, u00075, "system__img_lldS");
   u00076 : constant Version_32 := 16#8da1623b#;
   pragma Export (C, u00076, "system__img_decB");
   u00077 : constant Version_32 := 16#3171bbbc#;
   pragma Export (C, u00077, "system__img_decS");
   u00078 : constant Version_32 := 16#9777733a#;
   pragma Export (C, u00078, "system__img_lliB");
   u00079 : constant Version_32 := 16#8e13e7b6#;
   pragma Export (C, u00079, "system__img_lliS");
   u00080 : constant Version_32 := 16#f12dc122#;
   pragma Export (C, u00080, "system__ioB");
   u00081 : constant Version_32 := 16#011e4528#;
   pragma Export (C, u00081, "system__ioS");
   u00082 : constant Version_32 := 16#6eec0579#;
   pragma Export (C, u00082, "system__text_ioB");
   u00083 : constant Version_32 := 16#ea6ee296#;
   pragma Export (C, u00083, "system__text_ioS");
   u00084 : constant Version_32 := 16#fa02625b#;
   pragma Export (C, u00084, "system__bb__timing_eventsB");
   u00085 : constant Version_32 := 16#e31959dd#;
   pragma Export (C, u00085, "system__bb__timing_eventsS");
   u00086 : constant Version_32 := 16#08b6a2c6#;
   pragma Export (C, u00086, "system__multiprocessors__fair_locksB");
   u00087 : constant Version_32 := 16#a70e2885#;
   pragma Export (C, u00087, "system__multiprocessors__fair_locksS");
   u00088 : constant Version_32 := 16#51eaa4e5#;
   pragma Export (C, u00088, "system__multiprocessors__spin_locksB");
   u00089 : constant Version_32 := 16#9ac42bf1#;
   pragma Export (C, u00089, "system__multiprocessors__spin_locksS");
   u00090 : constant Version_32 := 16#90e7c9a9#;
   pragma Export (C, u00090, "system__machine_codeS");
   u00091 : constant Version_32 := 16#ea3a1db8#;
   pragma Export (C, u00091, "system__task_primitives__operationsB");
   u00092 : constant Version_32 := 16#86647383#;
   pragma Export (C, u00092, "system__task_primitives__operationsS");
   u00093 : constant Version_32 := 16#b11feb05#;
   pragma Export (C, u00093, "system__taskingB");
   u00094 : constant Version_32 := 16#d21936c1#;
   pragma Export (C, u00094, "system__taskingS");
   u00095 : constant Version_32 := 16#81c6b8c3#;
   pragma Export (C, u00095, "system__task_infoB");
   u00096 : constant Version_32 := 16#7e7c505d#;
   pragma Export (C, u00096, "system__task_infoS");
   u00097 : constant Version_32 := 16#0f8eba36#;
   pragma Export (C, u00097, "system__tasking__debugB");
   u00098 : constant Version_32 := 16#6aaf7877#;
   pragma Export (C, u00098, "system__tasking__debugS");
   u00099 : constant Version_32 := 16#ffd0e681#;
   pragma Export (C, u00099, "system__tracebackB");
   u00100 : constant Version_32 := 16#1e81dd04#;
   pragma Export (C, u00100, "system__tracebackS");
   u00101 : constant Version_32 := 16#ff8c918e#;
   pragma Export (C, u00101, "interfaces__cS");
   u00102 : constant Version_32 := 16#07225387#;
   pragma Export (C, u00102, "sporadic_and_protected_procedureB");
   u00103 : constant Version_32 := 16#aeff043b#;
   pragma Export (C, u00103, "sporadic_and_protected_procedureS");
   u00104 : constant Version_32 := 16#b5212fb5#;
   pragma Export (C, u00104, "ada__real_time__delaysB");
   u00105 : constant Version_32 := 16#4d02654a#;
   pragma Export (C, u00105, "ada__real_time__delaysS");
   u00106 : constant Version_32 := 16#abcef23c#;
   pragma Export (C, u00106, "system__tasking__protected_objectsB");
   u00107 : constant Version_32 := 16#5d67c5d7#;
   pragma Export (C, u00107, "system__tasking__protected_objectsS");
   u00108 : constant Version_32 := 16#bd407844#;
   pragma Export (C, u00108, "system__tasking__protected_objects__single_entryB");
   u00109 : constant Version_32 := 16#b32b1cf9#;
   pragma Export (C, u00109, "system__tasking__protected_objects__single_entryS");
   u00110 : constant Version_32 := 16#1f3e7a4f#;
   pragma Export (C, u00110, "system__tasking__protected_objects__multiprocessorsB");
   u00111 : constant Version_32 := 16#cbefcf88#;
   pragma Export (C, u00111, "system__tasking__protected_objects__multiprocessorsS");
   u00112 : constant Version_32 := 16#7cc41d8a#;
   pragma Export (C, u00112, "system__tasking__restricted__stagesB");
   u00113 : constant Version_32 := 16#5eca94a0#;
   pragma Export (C, u00113, "system__tasking__restricted__stagesS");
   u00114 : constant Version_32 := 16#36859160#;
   pragma Export (C, u00114, "system__tasking__restrictedS");
   u00115 : constant Version_32 := 16#ccc6d0aa#;
   pragma Export (C, u00115, "system_timeS");
   u00116 : constant Version_32 := 16#6b556097#;
   pragma Export (C, u00116, "system__memoryB");
   u00117 : constant Version_32 := 16#55d70e72#;
   ...
   --  sporadic_and_protected_procedure%s
   --  unit02%b
   --  system_time%s
   --  sporadic_and_protected_procedure%b
