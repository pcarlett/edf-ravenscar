...
--  Necessary for deadlines definitions
...
package System.BB.Threads is
   ...
   function Get_Affinity
     (Thread : Thread_Id) return System.Multiprocessors.CPU_Range;
   pragma Inline (Get_Affinity);
   --  Return CPU affinity of the given thread (maybe Not_A_Specific_CPU)

   function Get_CPU
     (Thread : Thread_Id) return System.Multiprocessors.CPU;
