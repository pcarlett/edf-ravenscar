...
--  Necessary for deadlines support
...
package System.Tasking.Protected_Objects is
   ...
   --  Initialize the Object parameter so that it can be used by the runtime
   --  to keep track of the runtime state of a protected object in an EDF
   --  scheduling.
...
private
   type Protection is record
      ...
      Floor : System.BB.Deadlines.Relative_Deadline;
      --  Floor deadline associated to the protected object
