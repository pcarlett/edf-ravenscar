...
package System.OS_Interface is
   ...
   procedure Initialize
     (Environment_Thread : Thread_Id;
      ...
      Main_Rel_Deadline  : System.BB.Deadlines.Relative_Deadline)
   ...
   --  Get the current base relative deadline of a thread

   procedure Set_Absolute_Deadline
            (Abs_Deadline  : System.BB.Deadlines.Absolute_Deadline)
     renames System.BB.Threads.Set_Absolute_Deadline;
   ...
   function Current_Relative_Deadline (CPU_Id : Multiprocessors.CPU)
            return System.BB.Deadlines.Relative_Deadline
     renames System.BB.Threads.Queues.Current_Relative_Deadline;
   --  Return the active relative deadline of the current thread or
   --  System.BB.Deadlines.Relative_Deadline (0) if no threads
   --  are running.

   function Current_Absolute_Deadline (CPU_Id : Multiprocessors.CPU)
            return System.BB.Deadlines.Absolute_Deadline
     renames System.BB.Threads.Queues.Current_Absolute_Deadline;
   --  Return the active absolute deadline of the current thread or
   --  Ada.Deadlines.Absolute_Deadline'Last if no threads
   --  are running.
